...
const WhyusModule = () => {
    ...
    return (
        <div>
            <Container>
                <h2>Why Us?</h2><br/>
                <p>Mengapa harus milih Binar Car Rental?</p><br/>
            </Container>
            <Container>
                <div className='d-flex flex-wrap justify-content-around' style={{gap:"32px"}}>
                    <Card className='cardWhy'>
                        <div className="card-body">
                        <img src={icon_thumb}/><br/><br/>
                        <h3>Mobil Lengkap</h3>
