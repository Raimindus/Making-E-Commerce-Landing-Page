        ...
        <Container>
            <Row>
                ...
                <Col md={2} className="ps-5">
                    <div class="headertext" style={{marginRight:"1px"}}>
                        <HashLink className='text-decoration-none' style={{color:'black'}} smooth to='/#services'>
                            <p>Our Services</p>
                        </HashLink> 
                        <HashLink className='text-decoration-none' style={{color:'black'}} smooth to='/#about'>
                            <p>Why Us</p>
                        </HashLink>
                ...
                <Col md={3} me={5}>
                    ...
                    <Container className='px-0'>
                        ...
                        <img className="socialbutton" src={icon_instagram} alt = 'instagram'/>
